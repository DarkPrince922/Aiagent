...
data class ProviderSettings(
    ...
    /**
     * Выполнять действия в чате без вопроса.
     *
     * В автономной задаче так работало всегда — там спрашивать некого. Включено по умолчанию:
     * приложение личное, и подтверждение каждого действия оказалось не защитой, а помехой.
     * Выключается тумблером в настройках или молнией в шапке чата.
     */
