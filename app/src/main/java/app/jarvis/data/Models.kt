...
data class ProviderSettings(
    ...
    /**
     * Выполнять опасные действия в чате без вопроса.
     *
     * В автономной задаче так работало всегда — там спрашивать некого. В чате каждое
     * изменение внешнего состояния останавливало ход до нажатия «Разрешить».
     */
